...
public class AddReceptionist2 {
    ...
    public AddReceptionist2(){
        
    }
    public AddReceptionist2( String fname,String lname, String sex, String bdate,String username,String password,String contract,
                        String status,String email, String phone, String address, byte[] pimg) {
        this.fname = fname;
        this.lname = lname;
        this.sex = sex;
        this.bdate = bdate;
    ...
    public boolean addNew(){
        ...
        Statement statement;
        try{
            String sql = "SELECT * FROM receptionist_registration WHERE u_id='"+id+"'";
            Class.forName(driver);
           con =  DriverManager.getConnection(url, "root", "");
       ...
       return null;
        ...
        //method for displaying all receptionists records on jtable
        public ResultSet getAll() {
        Statement statement;
        try{
            String sql = "SELECT * FROM receptionist_registration ORDER BY u_id ASC";
            Class.forName(driver);
           con =  DriverManager.getConnection(url, "root", "");
            statement = con.createStatement();
            ResultSet res = statement.executeQuery(sql);
       ...
       return null;
        ...
        try{
            String sql = "DELETE FROM receptionist_registration WHERE u_id='"+id +"' ";
            Class.forName(driver);
            con =  DriverManager.getConnection(url,"root","");
            Statement statement = con.createStatement();
            statement.executeUpdate(sql);
        ...
        try{
            String sql = "UPDATE receptionist_registration SET "
                    + "u_fname='"+ fname +"',"
                    + "u_lname='"+ lname +"',"
                    + "u_sex='"+ sex +"',"
                    + "u_bdate='"+ bdate +"',"
