...
public class Doctors extends javax.swing.JFrame {
    ...
    public Doctors() {
        ...
        Doctors2 a = new Doctors2();
        ResultSet res = null;
        try{
            res = a.getAll();
            res.beforeFirst();
            while(res.next()){
                model.addRow(new Object[]{Integer.parseInt(res.getString(1)),res.getString(2),res.getString(3),res.getString(4),res.getString(5),res.getString(6),res.getString(9),res.getString(10),res.getString(11),res.getString(12),res.getString(13)});
            }
        }catch(Exception e){
    ...
    private void initComponents() {
        ...
        jPanel11.add(jLabelHome1, new org.netbeans.lib.awtextra.AbsoluteConstraints(1190, 10, 90, 60));

        jLabel27.setFont(new java.awt.Font("Tahoma", 0, 36)); // NOI18N
        jLabel27.setForeground(new java.awt.Color(255, 255, 255));
        jLabel27.setText("All Doctors ");
        ...
        jPanel11.add(jLabel28, new org.netbeans.lib.awtextra.AbsoluteConstraints(1190, 70, -1, -1));

        Logo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Doctor/doctor.png"))); // NOI18N
        jPanel11.add(Logo, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 0, 120, 90));

        jPanel10.add(jPanel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1530, -1));
        ...
        tblRecords.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "DocID", "FName", "LName", "Sex", "Bdate", "Address", "Phone", "Status", "Email", "Contract", "DRegistered"
            }
        ) {
        ...
        jPanel10.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 160, 1290, 460));
        ...
        jPanel10.add(btnRefresh, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 110, 100, -1));

        jTabbedPane1.addTab("Doctors", jPanel10);
        ...
        jLabel13.setText("Delete Doctor");
        ...
        Logo1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Doctor/doctor.png"))); // NOI18N
        jPanel6.add(Logo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 0, 120, 90));

        jPanel5.add(jPanel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1460, 90));
        ...
        jTabbedPane1.addTab("Delete Doctor", jPanel1);
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        Doctors2 d = new Doctors2();
        int p = JOptionPane.showConfirmDialog(null,"Are you sure you want to delete Doctor?","Hospital Management System",JOptionPane.YES_NO_OPTION);
        if(p==0){
            d.deleteRecord(id);
